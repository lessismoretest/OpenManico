...
struct CircleRingSettingsView: View {
    ...
    private func getCirclePicturesPath() -> String? {
        ...
        let possiblePaths = [
            // 优先尝试开发环境中的直接路径
            "/Users/lessismore/Desktop/Archive/CursorCode/Opti/Opti/Views/circlepictures",
    ...
    private func copyPredefinedImagesToCacheDirectory(sourcePath: String? = nil, targetPath: String) {
        ...
        if let sourcePath = sourcePath {
            ...
            possibleSourcePaths = [
                "/Users/lessismore/Desktop/Archive/CursorCode/Opti/Opti/Views/circlepictures",  // 直接开发路径
